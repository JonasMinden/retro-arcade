...
if (canvas) {
  ...
  function createMaze() {
    return [
      ...
      { x: 76, y: 60, w: 18, h: 130 },
      { x: 76, y: 230, w: 18, h: 120 },
      { x: 160, y: 20, w: 18, h: 108 },
      { x: 160, y: 162, w: 18, h: 170 },
      { x: 242, y: 86, w: 18, h: 114 },
      { x: 242, y: 236, w: 18, h: 144 },
      { x: 324, y: 20, w: 18, h: 126 },
      { x: 324, y: 188, w: 18, h: 152 },
      { x: 406, y: 72, w: 18, h: 112 },
      { x: 406, y: 220, w: 18, h: 140 },
      { x: 492, y: 20, w: 18, h: 124 },
      { x: 492, y: 182, w: 18, h: 150 },
      { x: 20, y: 94, w: 110, h: 16 },
      { x: 172, y: 94, w: 104, h: 16 },
      { x: 318, y: 94, w: 112, h: 16 },
      { x: 472, y: 94, w: 148, h: 16 },
      { x: 20, y: 196, w: 102, h: 16 },
      { x: 162, y: 196, w: 114, h: 16 },
      { x: 316, y: 196, w: 92, h: 16 },
      { x: 448, y: 196, w: 172, h: 16 },
      { x: 20, y: 304, w: 130, h: 16 },
      { x: 192, y: 304, w: 120, h: 16 },
      { x: 352, y: 304, w: 122, h: 16 },
      { x: 512, y: 304, w: 108, h: 16 }
    ];
  }
  ...
  function resetGame() {
    ...
    state.enemies = [
      createEnemy(586, 58, 1),
      createEnemy(586, 358, 2),
      createEnemy(330, 356, 3),
    ];
    state.rocks = [];
    state.particles = [];
